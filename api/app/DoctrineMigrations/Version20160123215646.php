...
class Version20160123215646 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE event_dto (id INT AUTO_INCREMENT NOT NULL, tide_uuid VARCHAR(255) NOT NULL, event_class VARCHAR(255) NOT NULL, serialized_event LONGTEXT NOT NULL, event_datetime TIMESTAMP(6) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
