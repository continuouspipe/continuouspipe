Feature:
  ...
  Scenario: I can create an initialization token that will be used by the client
    ...
    And I create an initialization token for the development environment "00000000-0000-0000-0000-000000000000" of the flow "00000000-0000-0000-0000-000000000000" with the following parameters:
    """
    {
