Feature:
  ...
  Scenario: I can create an initialization token that will be used by the client
    ...
    And the created API key for the user "samuel" will have the key "00000000-1111-1111-0000-000000000000"
    ...
    Then I receive a token that contains the following base64 decoded and comma separated values:
      ...
      | 00000000-1111-1111-0000-000000000000 | 00000000-0000-0000-0000-000000000000 | 00000000-0000-0000-0000-000000000000        |  samuel           | cpdev/sroze |
