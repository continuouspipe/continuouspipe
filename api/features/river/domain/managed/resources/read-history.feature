Feature:
  ...
  Scenario: I can't get flow usage without being authenticated
    When I request the resource usage of the flow "00000000-0000-0000-0000-000011112222" from the "2017-08-01T00:00:00Z" to "2017-09-01T00:00:00Z" with a "P1D" interval
  ...
  Scenario: I can get my flow usage in the last 30 days
    ...
    And the following resource usage history entry have been saved:
      ...
      | 2017-07-29T12:00:00Z | 00000000-0000-0000-0000-000011112222 | master                 | 100m         | 1Gi             | 200m       | 1500Mi        |
      | 2017-08-02T12:00:00Z | 00000000-0000-0000-0000-000011112222 | master                 | 200m         | 2Gi             | 400m       | 3Gi           |
      | 2017-08-03T12:00:00Z | 00000000-0000-0000-0000-000011112222 | feature-branch         | 100m         | 1Gi             | 200m       | 1500Mi        |
      | 2017-08-03T14:00:00Z | 00000000-0000-0000-0000-000011112222 | feature-branch         | 0m           | 0               | 0m         | 0             |
      | 2017-08-05T12:00:00Z | 00000000-0000-0000-0000-000011112222 | master                 | 100m         | 1Gi             | 200m       | 1500Mi        |
      | 2017-08-05T12:00:00Z | 94b58d8e-0000-0000-0000-0a580a8405ef | some-noise             | 2            | 5Gi             | 3          | 10Gi          |
      | 2017-08-07T12:00:00Z | 00000000-0000-0000-0000-000011112222 | master                 | 600m         | 10Gi            | 800m       | 15Gi          |
      | 2017-08-08T12:00:00Z | 00000000-0000-0000-0000-000011112222 | master                 | 300m         | 1Gi             | 300m       | 800Mi        |
    When I request the resource usage of the flow "00000000-0000-0000-0000-000011112222" from the "2017-08-01T00:00:00Z" to "2017-09-01T00:00:00Z" with a "P1D" interval
