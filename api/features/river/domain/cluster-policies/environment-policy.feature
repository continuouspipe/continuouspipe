Feature:
  ...
  Scenario: The default values should be matching the policy
    Given the cluster "flex" of the team "my-team" have the following policies:
    """
    [
      {
    ...
    """
    When a tide is started for the branch "master"
    And the deployed environment name should be "abc123-9f89c-master"

  Scenario: The default values should be matching the policy, even for long branch names
    Given the cluster "flex" of the team "my-team" have the following policies:
    """
    [
      {
                    ...
                    app:
                        specification:
                            source:
                                image: foo/bar
    """
    When a tide is started for the branch "feature/this-is-a-very-very-long-branch-name-describing-the-feature"
    And the deployed environment name should be "abc123-9f89c-feature-this-is-a-very-very-long-branch-e61cb61c01"
