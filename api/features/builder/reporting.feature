Feature:
  ...
  Scenario: It publishes a report when a build is created
    When I create a build "00000000-0000-0000-0000-000000000000" with the engine "docker"
  ...
  Scenario: The build is started
    Given there is a build "00000000-0000-0000-0000-000000000000" with the engine "docker"
  ...
  Scenario: It adds the durations to the report
    ...
    And there is a build "00000000-0000-0000-0000-000000000000" with the engine "docker"
